  ...
  <header class="admin-header-header">
    <div class="container admin-header-header__inner">
      ...
      <nav class="admin-header-nav" aria-label="Admin navigation">
        ...
        <a href="admin-products.html" class="admin-header-link">Produkty</a>
        <a href="admin-orders.html" class="admin-header-link admin-header-link--active" aria-current="page">Objednavky</a>
      </nav>
      <button type="button" class="admin-btn" onclick="logout()">
        <a href="login-admin.html">ODHLASIŤ</a>
      </button>
    </div>
  </header>
